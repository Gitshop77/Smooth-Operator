 ...
 *
 * Offline-primary: `catalog-bundled.ts` (generated by Agent A's
 * `scripts/build-models-catalog` from the models.dev dataset) is the committed
 * snapshot imported here as `BUNDLED_CATALOG`. It is always available at boot
...
/* ============================================================= *
 * Offline-primary snapshot (generated, not hand-authored).     *
 * ============================================================= */
