...
export function installPopupHandler(): void {
  ...
  // Override window.alert to capture + auto-dismiss.
  window.alert = function (message?: string): void {
    console.warn(`${LOG_PREFIX} Auto-dismissed alert:`, message);
  ...
  window.confirm = function (message?: string): boolean {
    console.warn(`${LOG_PREFIX} Auto-accepted confirm:`, message);
  ...
  window.prompt = function (message?: string, defaultValue?: string): string | null {
    console.warn(`${LOG_PREFIX} Auto-responded prompt:`, message);
    pendingAlert = {
      kind: "prompt",
      text: String(message ?? ""),
