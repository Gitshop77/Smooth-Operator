 ...
 * - `src/lib/agent/dom/extraction/page-state.ts` imports `getShadowRoot`
 * STATICALLY and directly from `../annotation/shadow-piercer` (skipping this
 * shim) to avoid an extra indirection on the hot extraction path.
 * - The canonical module is `src/lib/agent/dom/annotation/shadow-piercer.ts`.
 *
