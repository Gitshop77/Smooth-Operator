...
export const tokenLabel = document.getElementById("tokenLabel") as HTMLSpanElement | null;
...
export const storageVersionBanner = document.getElementById("storageVersionBanner") as HTMLDivElement | null;
export const storageVersionReason = document.getElementById("storageVersionReason") as HTMLDivElement | null;
