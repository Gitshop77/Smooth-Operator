...
if (typeof chrome !== "undefined" && chrome.storage?.local) {
  ...
  chrome.storage.local.get(
    [
      ...
      STORAGE_KEYS.screenshotQuality, STORAGE_KEYS.screenshotImageTokens,
      STORAGE_KEYS.screenshotMaxDimension, STORAGE_KEYS.screenshotMaxBytes,
      STORAGE_KEYS.enableScreenshots, STORAGE_KEYS.stealthEnabled,
