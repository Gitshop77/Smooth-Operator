...
export const FEATURED_PROVIDERS: ProviderDef[] = [
  ...
  { id: "opencode",   label: "OpenCode",        catalogId: CATALOG_PROVIDER_ID_MAP.opencode,   hint: "OpenCode — connect any of 75+ LLM providers via OpenCode. Hosted Zen endpoint is https://opencode.ai/zen/v1; self-hosted `opencode serve` listens on http://localhost:4096.", defaultModel: "", defaultBaseUrl: "https://opencode.ai/zen/v1", needsKey: true, keyPlaceholder: "your-opencode-key", keyUrl: "https://opencode.ai/docs/providers" },
  { id: "openai",     label: "OpenAI",          catalogId: CATALOG_PROVIDER_ID_MAP.openai,     hint: "OpenAI — GPT-5.5, GPT-5.4, and o-series reasoning models.", defaultModel: "gpt-5.5", needsKey: true, keyPlaceholder: "sk-proj-...", keyUrl: "https://platform.openai.com/api-keys" },
  { id: "anthropic",  label: "Anthropic",       catalogId: CATALOG_PROVIDER_ID_MAP.anthropic,  hint: "Anthropic — Claude Sonnet 5, Opus 4.8, Fable 5, Haiku 4.5.", defaultModel: "claude-sonnet-5", needsKey: true, keyPlaceholder: "sk-ant-api03-...", keyUrl: "https://console.anthropic.com/" },
  ...
  { id: "xai",        label: "xAI (Grok)",      catalogId: CATALOG_PROVIDER_ID_MAP.xai,        hint: "xAI — Grok 4.3 models.", defaultModel: "grok-4.3", defaultBaseUrl: "https://api.x.ai/v1", needsKey: true, keyPlaceholder: "xai-...", keyUrl: "https://x.ai/api" },
];
