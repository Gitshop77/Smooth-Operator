...
tests/                      Vitest test suite (1,588 `test()`/`it()` across 107 files, all green)
...
- `npm run test` — Vitest suite (1,588 `test()`/`it()` across 107 files)
...
`npm run test` runs the Vitest suite (1,588 `test()`/`it()` across 107 files):
