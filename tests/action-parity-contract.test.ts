...
const BACKGROUND_ROUTE: Record<ActionType, BackgroundRoute> = {
  ...
  find_text: "none", extract: "none", done: "none", search: "none", upload_file: "none", screenshot: "SCREENSHOT", inspect_visual: "none", save_as_pdf: "SAVE_AS_PDF",
...
const HANDLER_BY_ACTION: Partial<Record<ActionType, string>> = {
  ...
  alert_send_keys: "handleAlertSendKeys", inspect_visual: "handleInspectVisual", detect_visual: "handleDetectVisual", list_tabs: "handleListTabs",
